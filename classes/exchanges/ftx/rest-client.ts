...
export class RestClient {
  ...
  changeSubaccountName(params: { nickname: string; newNickname: string }): GenericAPIResponse {
  ...
  getOrderbook(params: { marketName: string; depth?: number }): GenericAPIResponse {
  ...
  getDepositAddress(params: { coin: string; method?: string }): GenericAPIResponse {
    const suffix = params.method ? `?method=${params.method}` : ""
    return this.requestWrapper.get(`wallet/deposit_address/${params.coin}${suffix}`)
  }

  getDepositHistory(params?: { limit?: number; start_time?: number; end_time?: number }): GenericAPIResponse {
    return this.requestWrapper.get("wallet/deposits", params)
  }

  getWithdrawalHistory(params?: { limit?: number; start_time?: number; end_time?: number }): GenericAPIResponse {
  ...
  getAirdrops(params?: { limit?: number; start_time?: number; end_time?: number }): GenericAPIResponse {
  ...
  getOpenTriggerOrders(params?: { market?: string; type?: ConditionalOrderType }): GenericAPIResponse {
  ...
  modifyOrder(params: { orderId: string; price?: number; size?: number; clientId?: string }): GenericAPIResponse {
  ...
  requestQuote(params: { fromCoin: string; toCoin: string; size: number }): GenericAPIResponse {
  ...
  submitLendingOffer(params: { coin: string; size: number; rate: number }): GenericAPIResponse {
  ...
  getFundingPayments(params?: { start_time?: number; end_time?: number; future?: string }): GenericAPIResponse {
  ...
  getPublicOptionsTrades(params?: { start_time?: number; end_time?: number; limit?: number }): GenericAPIResponse {
    return this.requestWrapper.get(`options/trades`, params)
  }

  getOptionsFills(params?: { start_time?: number; end_time?: number; limit?: number }): GenericAPIResponse {
