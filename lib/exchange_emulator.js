...
class ExchangeEmulator {
	...
	set quote_coin_balance_in_orders(value) {
		this._set_locked_balance(this.quote_currency, value);
	}

	set quote_coin_balance_not_in_orders(value) {
		this._set_free_balance(this.quote_currency, value);
	}
	...
	set base_coin_balance_not_in_orders(value) {
		this._set_free_balance(this.base_currency, value);
	}
	...
	set base_coin_balance_in_orders(value) {
		this._set_locked_balance(this.base_currency, value);
	}
	...
	get quote_coin_balance_total() {
		return this.total_balance(this.quote_currency);
	}
	...
	_execute_hit_limit_sell({ order } = {}) {
		...
		this.quote_coin_balance_not_in_orders = this.total_balance(this.quote_currency).plus(quote_volume);
	...
	balance_in_quote_coin() {
		var balance_in_quote_coin = this.total_balance(this.quote_currency);
		if (
			this.base_coin_balance_not_in_orders.isGreaterThan(0) ||
			this.base_coin_balance_in_orders.isGreaterThan(0)
		) {
