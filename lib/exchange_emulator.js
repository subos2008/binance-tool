...
class ExchangeEmulator {
	...
	// total portfolio in whatever base currency is supplied
	async get_portfolio_value({ quote_currency } = {}) {
		assert(quote_currency);
		console.log('Issue: assuming quote currency');
		return this.quote_coin_balance;
	}
