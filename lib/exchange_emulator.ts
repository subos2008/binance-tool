...
//       })
//     }
//     this.utils = new StaticBinanceAlgoUtils({logger})
//   }
...
//   // trades call this
//   _exchange_balances_from_locked_to_free(
//     from_currency: string,
//     from_amount: BigNumber,
//     to_currency: string,
//     to_amount: BigNumber
//   ) {
...
//   async add_limit_buy_order({
//     base_volume,
//     limit_price,
//     pair,
//   }: {
//     base_volume: BigNumber | string
//     limit_price: BigNumber | string
//     pair: string
//   }) {
...
//   async add_stop_loss_limit_sell_order({
//     base_volume,
//     price,
//     stop_price,
//     pair,
