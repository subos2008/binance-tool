...
function quote_volume_at_price_to_base_volume({ quote_volume, price }: { quote_volume: BigNumber, price: BigNumber }) {
  assert(quote_volume);
  assert(price);
...
// TODO: rounding
function base_volume_at_price_to_quote_volume({ base_volume, price }: { base_volume: BigNumber, price: BigNumber }) {
...
// Binance
function munge_and_check_quantity({ exchange_info, symbol, volume }: { exchange_info: any, symbol: string, volume: BigNumber }) {
...
// Binance
function munge_and_check_price({ exchange_info, symbol, price }: { exchange_info: any, symbol: string, price: BigNumber }) {
...
// Binance
function check_notional({ price, volume, exchange_info, symbol }: { exchange_info: any, symbol: string, price: BigNumber, volume: BigNumber }) {
  assert(typeof volume !== 'undefined');
  assert(typeof price !== 'undefined');
  assert(exchange_info);
  assert(symbol);
