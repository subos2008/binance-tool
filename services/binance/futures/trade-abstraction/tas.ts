...
import { FuturesTradeAbstractionService as TradeAbstractionService } from "./futures-trade-abstraction-service"
...
// const price_getter: CurrentPriceGetter = new BinanceFuturesPriceGetter({
//   logger,
